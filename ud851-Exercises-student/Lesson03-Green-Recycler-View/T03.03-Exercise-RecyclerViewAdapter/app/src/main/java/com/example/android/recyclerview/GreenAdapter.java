...
/**
 * We couldn't come up with a good name for this class. Then, we realized that this lesson is about
 * RecyclerView.
 *
...
public class GreenAdapter {
  ...
  class NumberViewHolder extends RecyclerView.ViewHolder {
     ...
     * below.
     *
     * @param itemView The View that you inflated in {@link GreenAdapter#onCreateViewHolder(ViewGroup,
     * int)}
     */
