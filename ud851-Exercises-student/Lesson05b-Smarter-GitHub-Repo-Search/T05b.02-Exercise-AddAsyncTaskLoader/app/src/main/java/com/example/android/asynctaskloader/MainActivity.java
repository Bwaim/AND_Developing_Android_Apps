...
public class MainActivity extends AppCompatActivity implements LoaderCallbacks<String> {
  ...
  /**
   * This method retrieves the search text from the EditText, constructs the URL (using {@link
   * NetworkUtils}) for the github repository you'd like to find, displays that URL in a TextView,
   * and finally request that an AsyncTaskLoader performs the GET request.
   */
    ...
    return new AsyncTaskLoader<String>(this) {
      ...
      public String loadInBackground() {
        ...
        try {
          ...
          return NetworkUtils.getResponseFromHttpUrl(request);
        } catch (IOException e) {
          e.printStackTrace();
        }
        return null;
