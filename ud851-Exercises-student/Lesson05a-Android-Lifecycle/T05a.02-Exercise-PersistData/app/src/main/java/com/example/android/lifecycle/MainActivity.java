...
public class MainActivity extends AppCompatActivity {
  ...
  /**
   * Logs to the console and appends the lifecycle method name to the TextView so that you can view
   * the series of method callbacks that are called both from the app and from within Android
   * Studio's Logcat.
   *
