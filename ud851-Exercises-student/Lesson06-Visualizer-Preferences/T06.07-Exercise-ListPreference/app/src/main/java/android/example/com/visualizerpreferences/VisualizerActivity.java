...
public class VisualizerActivity extends AppCompatActivity implements
  ...
  private void setupSharedPreferences() {
    ...
    mVisualizerView
        .setShowMid(sharedPreferences.getBoolean(getString(R.string.pref_show_mid_range_key),
    ...
    loadColorShape(sharedPreferences);
    // Register the listener
    sharedPreferences.registerOnSharedPreferenceChangeListener(this);
  }

  private void loadColorShape(SharedPreferences sharedPreferences) {
