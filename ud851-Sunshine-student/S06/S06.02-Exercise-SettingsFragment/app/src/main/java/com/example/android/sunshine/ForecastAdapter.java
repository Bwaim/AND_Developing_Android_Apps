...
/**
 * {@link ForecastAdapter} exposes a list of weather forecasts to a {@link
...
public class ForecastAdapter extends
   ...
   * In this method, we update the contents of the ViewHolder to display the weather details for
  ...
  /**
   * This method is used to set the weather forecast on a ForecastAdapter if we've already created
