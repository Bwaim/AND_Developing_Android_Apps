...
public final class SunshineWeatherUtils {
  ...
  /**
   * Temperature data is stored in Celsius by our app. Depending on the user's preference, the app
   * may need to display the temperature in Fahrenheit. This method will perform that temperature
   * conversion if necessary. It will also format the temperature so that no decimal points show.
   * Temperatures will be formatted to the following form: "21°C"
   *
  ...
  /**
   * This method will format the temperatures to be displayed in the following form: "HIGH°C /
   * LOW°C"
   *
   * @param context Android Context to access preferences and resources
  ...
  /**
   * This method uses the wind direction in degrees to determine compass direction as a String. (eg
   * NW) The method will return the wind String in the following form: "2 km/h SW"
   *
   * @param context Android Context to access preferences and resources
   * @param windSpeed Wind speed in kilometers / hour
   * @param degrees Degrees as measured on a compass, NOT temperature degrees! See
   ...
   * @param weatherId from OpenWeatherMap API response http://bugs.openweathermap.org/projects/api/wiki/Weather_Condition_Codes
  ...
  /**
   * Helper method to provide the icon resource id according to the weather condition id returned by
  ...
  /**
   * Helper method to provide the art resource id according to the weather condition id returned by
   * the OpenWeatherMap call.
   *
   * @param weatherId from OpenWeatherMap API response
   * @return resource id for the corresponding icon. -1 if no relation is found.
