 ...
 * responsible for orchestrating proper navigation when the up button is clicked. When the up button
 * is clicked from the SettingsActivity, we want to navigate to the Activity that the user came from
 * to get to the SettingsActivity.
 * <p>
