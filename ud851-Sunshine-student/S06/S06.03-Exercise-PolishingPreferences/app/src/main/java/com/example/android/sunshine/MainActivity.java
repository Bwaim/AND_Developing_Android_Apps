...
public class MainActivity extends AppCompatActivity implements
  ...
  /**
   * This method is used when we are resetting data, so that at one point in time during a refresh
  ...
  /**
   * This method uses the URI scheme for showing a location found on a map in conjunction with an
   * implicit Intent. This super-handy intent is detailed in the "Common Intents" page of Android's
   * developer site:
   *
   * @see "http://developer.android.com/guide/components/intents-common.html#Maps"
   * <p>
   * Protip: Hold Command on Mac or Control on Windows and click that link to automagically open the
   * Common Intents page
   */
